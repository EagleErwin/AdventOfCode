...
procedure Day11_1 is
   ...
   begin
      --Put_Line("Flashing (" & Integer'Image(Row_Idx) & "," & Integer'Image(Col_Idx) & ")");
   ...
   function Flash (Octopuses : in out Energy_Field.Vector) return Integer is
...
begin
   ...
   for I in 1 .. Number_Of_Steps loop
      Answer := Answer + Flash(Octopuses);
   end loop Step_Loop;

   -- 204
   Put_line("The total number of flashes after "
            & Integer'Image(Number_Of_Steps) & " steps is "
