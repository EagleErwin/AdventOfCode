...
procedure Day24_2 is
   ...
   Max_Boost : constant Integer := 2000; -- 1570 is already sufficient
   ...
   begin
      ...
      if Target_Army.Party = Immune then
         Damage := Damage + Boost;
      end if;
   ...
   function Determine_Remaining_Units(Immune_Army    : in Army;
                                      Infection_Army : in Army;
                                      Winning_Side   : out Side) return Integer is
      Winner : Army;
      Result : Integer := 0;
   begin
